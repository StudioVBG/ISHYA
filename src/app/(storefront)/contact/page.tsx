...
const socials = [
  { icon: Instagram, label: "Instagram", href: "https://instagram.com/ishya.bijoux" },
  { icon: Facebook, label: "Facebook", href: "https://facebook.com/ishya.bijoux" },
];
