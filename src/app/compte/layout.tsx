              ...
              <div className="sticky top-24">
                ...
                <div className="flex items-center gap-3 mb-8 pb-6 border-b border-border">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted">Membre Argent</p>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-border">
                  <button className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-muted hover:text-destructive transition-colors w-full">
