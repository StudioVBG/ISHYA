...
function VariantOptionsPanel({
  ...
  return (
    <div className="border-t border-border bg-bone-soft/40 p-4 space-y-3">
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          ...
          className="text-xs text-steel hover:text-ember disabled:opacity-40 shrink-0"
        >
          Tout décocher
        </button>
      </div>
          ...
          return (
            <div key={v.id} className="flex items-center gap-2 text-sm">
              ...
              <div className="flex-1 min-w-0">
                ...
                {v.sku && v.name && (
                  <span className="text-xs text-steel-soft font-mono ml-2">
                    {v.sku}
                  </span>
                )}
                {!v.isActive && (
                  <span className="ml-2 text-xs text-steel-soft italic">
                    (inactive)
                  </span>
                )}
              </div>
              <div className="flex items-center gap-1">
                ...
                <input
                  ...
                  className="w-20 px-2 py-1 border border-border rounded text-xs text-right disabled:opacity-40 disabled:bg-bone-soft"
                />
                <span className="text-xs text-steel-soft">€</span>
              </div>
            </div>
      ...
      <div className="flex justify-end pt-1">
        <button
          ...
          onClick={handleSave}
          disabled={isSaving}
          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-ember text-white rounded-lg text-xs font-medium hover:bg-ember-deep transition-colors disabled:opacity-50"
        >
