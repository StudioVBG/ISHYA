...
import {
  LayoutDashboard, Package, FolderTree, Layers, Gift,
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-4 border-t border-gray-700 space-y-1">
        ...
        <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-400 hover:bg-gray-800 hover:text-red-400 transition-colors w-full">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-3 pl-4 border-l border-gray-200">
              <div className="w-8 h-8 rounded-full bg-terracotta/10 flex items-center justify-center">
                <span className="text-sm font-semibold text-terracotta">SA</span>
              </div>
              <div className="text-right">
                <p className="text-sm font-medium text-gray-900">Sophie A.</p>
                <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wide bg-gold/10 text-gold-dark">
                  Super Admin
                </span>
              </div>
            </div>
