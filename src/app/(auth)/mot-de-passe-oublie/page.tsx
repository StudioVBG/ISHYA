        ...
        {!isSuccess ? (
          ...
          >
            <motion.div variants={staggerItem}>
              <Link
                href="/connexion"
                className="inline-flex items-center gap-1.5 text-sm text-steel hover:text-ink transition-colors mb-8"
              >
          ...
          >
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-ember/10">
            ...
            <p className="mt-2 text-steel text-xs">
