      ...
      <div className="mx-auto max-w-3xl rounded-2xl bg-white border border-border shadow-xl p-5 sm:p-6">
        ...
        <div className="mt-5 flex flex-col sm:flex-row sm:items-center sm:justify-end gap-2">
          <button
            ...
            className="text-sm text-foreground underline underline-offset-2 sm:mr-auto"
          >
          ...
          {showDetails ? (
            <button
              type="button"
              onClick={saveChoices}
              className="px-4 py-2 rounded-lg text-sm font-medium bg-foreground text-white hover:bg-foreground"
            >
