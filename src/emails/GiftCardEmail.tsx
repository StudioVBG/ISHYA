      ...
      <Body style={{ margin: 0, backgroundColor: colors.bone, fontFamily: fontBody }}>
        <Container style={{ maxWidth: "600px", margin: "0 auto", backgroundColor: colors.bone }}>
          ...
          <Section style={{ padding: "8px 32px 32px" }}>
            ...
            <Text style={{ fontSize: "15px", lineHeight: "24px", color: colors.steel, margin: "0 0 24px" }}>
              {senderName ? (
                <>
                  <strong style={{ color: colors.ink }}>{senderName}</strong> vous offre une
            ...
            >
              ...
              <Hr style={{ borderColor: colors.ember, margin: "16px 0" }} />
              <Text
                style={{
                  margin: "0 0 6px",
                  fontSize: "12px",
            ...
            <Text style={{ fontSize: "12px", lineHeight: "20px", color: colors.steel, margin: 0 }}>
