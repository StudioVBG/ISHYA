      ...
      <Body style={{ margin: 0, backgroundColor: colors.ivory, fontFamily: fontBody }}>
        <Container style={{ maxWidth: "600px", margin: "0 auto", backgroundColor: colors.ivory }}>
          ...
          <Section style={{ padding: "8px 32px 32px" }}>
            ...
            >
              <Text style={{ margin: "0 0 6px", fontSize: "13px", color: colors.textMuted }}>Commande</Text>
              <Text style={{ margin: "0 0 16px", fontSize: "15px", fontWeight: 600, color: colors.black }}>
                #{orderNumber}
              </Text>
              <Text style={{ margin: "0 0 6px", fontSize: "13px", color: colors.textMuted }}>Transporteur</Text>
              <Text style={{ margin: "0 0 16px", fontSize: "15px", fontWeight: 600, color: colors.black }}>
                {carrier}
              </Text>
              <Text style={{ margin: "0 0 6px", fontSize: "13px", color: colors.textMuted }}>Numéro de suivi</Text>
              <Text
                style={{
                  margin: 0,
                  fontSize: "16px",
            ...
            <Text style={{ fontSize: "14px", color: colors.textMuted, margin: "0 0 24px" }}>
              <strong style={{ color: colors.black }}>Livraison estimée :</strong> {estimatedDeliveryDate}
            </Text>
            ...
            <Row>
              {items.slice(0, 3).map((item, i) => (
                <Column key={i} style={{ width: `${100 / Math.min(items.length, 3)}%`, padding: "0 6px", verticalAlign: "top" }}>
                  ...
                  />
                  <Text style={{ margin: 0, fontSize: "12px", color: colors.black, fontWeight: 600 }}>{item.name}</Text>
                  <Text style={{ margin: "4px 0 0", fontSize: "11px", color: colors.textMuted }}>× {item.quantity}</Text>
                </Column>
              ))}
            </Row>
